 ...
 * (className/style von außen), im Areal „Ohne Geldflüsse" statisch in Reihe.
 */
export function MoneyFlowAccountCard({
  ...
  return (
    <div
      className={cn(
        'w-32 rounded-lg border bg-card p-2.5 shadow-sm transition-all sm:w-40',
        className,
      )}
      style={style}
 ...
 */
export default function MoneyFlowChart({ flow }: { flow: MoneyFlow }) {
